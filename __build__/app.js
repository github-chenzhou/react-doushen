...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Movieitem = __webpack_require__(227);
	...
	var Movies = React.createClass({displayName: "Movies",
	  ...
	  render: function () {
	    ...
	    return (
	      ...
	      React.createElement("section", {id: "J_movies_list", className: "list", onTouchMove: this.handleScroll}, 
	          ...
	          React.createElement(Link, {className: "user_name cont_title", to: ("/movie/" + this.props.id)}, this.props.title), 
	            ...
	            React.createElement("ul", {className: "feed_pic_list"}, 
	               this.props.imgs.map(function(src, i) {
	                if(i < 4){
	                  return (
	                    React.createElement("li", {key: i}, React.createElement("span", {className: "pic_wrap"}, 
	                    React.createElement("img", {src: src, className: "J_feed_img", "data-src": "setSytle"}), 
